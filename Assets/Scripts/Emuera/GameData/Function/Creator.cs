	...
	internal static partial class FunctionMethodCreator
	{
		static FunctionMethodCreator()
		{
            methodList = new Dictionary<string, FunctionMethod>
            {
                ...
                // EM+EE SQLite real implementations
                ...
                ["SQL_EXECUTE_NON_QUERY"] = new SqlExecuteNonQueryMethod(),
                ...
                ["SQL_EXECUTE_SCALAR_S_PARAM"] = new SqlStrStubMethod(2),
                ["SQL_P_EXECUTE_SCALAR_LONG"] = new SqlStubMethod(3),
                ["SQL_P_EXECUTE_SCALAR_STRING"] = new SqlStrStubMethod(3),
                ["SQL_P_EXECUTE_NON_QUERY"] = new SqlStubMethod(3),
                ["SQL_P_EXECUTE_READER"] = new SqlStubMethod(3),
                ["SQL_EXECUTE_SCALAR_S"] = new SqlStrStubMethod(2),
                ...
                ["SQL_READER_GET_STRING"] = new SqlStrStubMethod(2),
                ...
                ["GDRAWTEXT"] = new MixedStubMethod(4),
                ["GETMETH"] = new MixedStubMethod(3),
                ["GETMETHS"] = new MixedStrStubMethod(3),
                ["EXISTMETH"] = new MixedStubMethod(1),
                ...
                ["HOTKEY_STATE"] = new MixedStubMethod(2),
                ["BITMAP_CACHE_ENABLE"] = new MixedStubMethod(1),
                ["GDRAWLINE"] = new MixedStubMethod(5),
                ["GDASHSTYLE"] = new MixedStubMethod(3),
                // Below: EM+EE functions not in original uEmuera base (stubs for compatibility)
                ["ENUMFUNCBEGINSWITH"] = new MixedStubMethod(2),
                ["ENUMFUNCENDSWITH"] = new MixedStubMethod(2),
                ["ENUMFUNCWITH"] = new MixedStubMethod(2),
                ["ENUMVARBEGINSWITH"] = new MixedStubMethod(2),
                ["ENUMVARENDSWITH"] = new MixedStubMethod(2),
                ["ENUMVARWITH"] = new MixedStubMethod(2),
                ["ENUMMACROBEGINSWITH"] = new MixedStubMethod(2),
                ["ENUMMACROENDSWITH"] = new MixedStubMethod(2),
                ["ENUMMACROWITH"] = new MixedStubMethod(2),
                ["MAP_TOXML"] = new MixedStrStubMethod(1),
                ["MAP_FROMXML"] = new MixedStubMethod(2),
                ["GDRAWGWITHROTATE"] = new MixedStubMethod(5),
                ["GGETFONT"] = new MixedStrStubMethod(1),
                ["GGETFONTSIZE"] = new MixedStubMethod(1),
                ["GGETFONTSTYLE"] = new MixedStubMethod(1),
                ["GGETTEXTSIZE"] = new MixedStubMethod(4),
                ["GGETBRUSH"] = new MixedStubMethod(1),
                ["GGETPEN"] = new MixedStubMethod(1),
                ["GGETPENWIDTH"] = new MixedStubMethod(1),
                ["FLOWINPUT"] = new MixedStubMethod(4),
                ["FLOWINPUTS"] = new MixedStubMethod(2),
                ["HOTKEY_STATE_INIT"] = new MixedStubMethod(2),
                ["ISDEFINED"] = new MixedStubMethod(1),
                ["OUTPUTLOG"] = new MixedStubMethod(2),
            };
